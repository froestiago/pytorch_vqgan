...
if __name__ == "__main__":
    ...
    # Initialize the VQLPIPSWithDiscriminator
    ...
    reconstructions = torch.randn(batch_size, channels, height, width)
    codebook_loss = torch.randn(batch_size)

    # Forward pass for generator update (optimizer_idx=0)
    optimizer_idx = 0
    global_step = 500
    loss, log = model(
